# -*- coding: utf-8 -*-
"""
Created on Sat Mar 28 00:00:13 2020
...
class SGAN():
    def __init__(self):
        ...
        -----------------------------------------------------------------------------------------------
        """ 
        optimizer =  K.optimizers.Adam(learning_rate=0.0002, beta_1=0.5, beta_2=0.1)
    ...
    def train(self, X_train, y_train, X_test, y_test, epochs, batch_size, save_interval):
        ...
        for epoch in range(epochs):
            ...
            fake_labels = tf.keras.utils.to_categorical(np.full((half_batch, 1), 
                                                        self.num_classes),
...
if __name__ == '__main__':
    ...
    """
    start = time.time() 
    sgan.train(X_train, y_train, X_test, y_test, epochs=200, batch_size=32, save_interval=5)
    end = time.time()
